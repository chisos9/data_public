...
# estimate model
load(file="parameters_model_CET_1754_2020.rda")
stateSpaceModelCET <- estimateModel(data, vP)
vP<-stateSpaceModelCET$parameters
save(vP,file="parameters_model_CET_1754_2020.rda")
...
# estimate model
load(file="parameters_model_DeBilt_1706_2020.rda")
stateSpaceModelDeBilt <- estimateModel(data, vP)
vP<-stateSpaceModelDeBilt$parameters
save(vP,file="parameters_model_DeBilt_1706_2020.rda")
